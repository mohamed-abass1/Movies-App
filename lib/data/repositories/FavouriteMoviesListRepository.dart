...
class MoviesFavouriteListRepositoryImpl implements GetFavouriteMoviesRepository{
  GetMoviesFavouriteDataSource getMoviesDataSource;
  MoviesFavouriteListRepositoryImpl ({required this.getMoviesDataSource});
Future<Either<Failures, GetAllFavouriteResponseEntity>> getFavouriteMoviesList() async {
